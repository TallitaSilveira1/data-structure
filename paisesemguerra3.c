...
Grafo grafo;
/* algoritmo usado para resolver o problema do menor caminho*/
void dijkstra (int origem, int destino)
{
    int w, w0;
    int fr[501], parnt[501];
    int cst[501];
/* usado para preencher um bloco de memoria com valor especifico*/
    memset (parnt, -1, sizeof(parnt));
    memset (cst, 999999, sizeof(cst));

    fr[origem] = origem;
    cst[origem] = 0;
/*while para verificar o custo de cada acordo*/
    while(1){
             int mincst = 999999;
             for(w = 0; w < grafo.v; w++){
